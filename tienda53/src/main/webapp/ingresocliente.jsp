...
<header>
  <nav class="navbar navbar-dark bg-dark navbar-expand-lg">
    ...
    <span class="span-login">Contraseña</span>
    <div class="input-group mb-3">
    <div class="input-group-prepend">
      <span class="input-group-text" id="basic-addon1"><i class="fas fa-key"></i></span>
    </div>
      <input id="inputpass" type="password" class="form-control" placeholder="Contraseña" aria-label="Contraseña" aria-describedby="basic-addon1">
    </div>  
    <div>
      <button type="button" class="btn btn-primary btn-login-ingresar" onclick="comparar()">Ingresar</button>
       <div id="error" class="alert alert-danger visually-hidden"
    role="alert">Usuario o contraseña incorrecta!
    </div>
    ...
    <div class="card-footer">
      <a href="#"><button class="btn btn-primary btn-login-opassword">¿Olvidaste la contraseña?</button></a>
    </div>
