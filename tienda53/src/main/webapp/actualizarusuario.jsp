...
<body>
	...
	<div class="card-login">
		...
		<div id="error" class="alert alert-danger visually-hidden"
			role="alert">Error al actualizar el usuario, el usuario no
			existe</div>
		...
		<form action="form1">
			...
			<input type="text" class="form-control"
				...
				required disabled="disabled"> <span
				class="input-group-text btn-card" id="inputGroup-sizing-default">Contraseña</span>
	...
	<script>
		function enviar() {
			...
			req.open('GET', baseUrl + '/consultarusuario?usuario=' + user,
					false);
			req.send(null);
			var usuario = null;
			if (req.status == 200)
